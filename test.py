...
if __name__ == "__main__":
    ...
    #de = os.path.join(opt.de_root, '*')
    #st = os.path.join(opt.st_root, '*')
    #ma = os.path.join(opt.mask_root, '*')
    #print(de)
    #print(st)
    #print(ma)
    ...
    de_paths = sorted(glob('/content/drive/My Drive/ReproductionDL/img_align_celeba_2/*.jpg'))
    st_paths = sorted(glob('/content/drive/My Drive/ReproductionDL/img_align_celeba_smooth_2/*.jpg'))
